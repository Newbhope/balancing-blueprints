...
void ABalancingBlueprintsPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void ABalancingBlueprintsPawn::FireShot(FVector FireDirection)
{
	...
	if (bCanFire == true)
	{
		...
		if (FireDirection.SizeSquared() > 0.0f)
		{
			...
			bCanFire = false;
			World->GetTimerManager().SetTimer(TimerHandle_ShotTimerExpired, this, &ABalancingBlueprintsPawn::ShotTimerExpired, FireRate);
...
void ABalancingBlueprintsPawn::ShotTimerExpired()
{
	bCanFire = true;
}
